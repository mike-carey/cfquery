...
//go:generate genny -in=../generics/query/generic-cf-service-base.go -out=gen-app-service-base.go -pkg query gen "CFObject=cfclient.App"
//go:generate genny -in=../generics/query/generic-cf-service-base_test.go -out=gen-app-service-base_test.go -pkg query_test gen "CFObject=cfclient.App"
...
//go:generate genny -in=../generics/query/generic-cf-service-base.go -out=gen-org-service-base.go -pkg query gen "CFObject=cfclient.Org"
//go:generate genny -in=../generics/query/generic-cf-service-base_test.go -out=gen-org-service-base_test.go -pkg query_test gen "CFObject=cfclient.Org"
...
//go:generate genny -in=../generics/query/generic-cf-service-base.go -out=gen-space-service-base.go -pkg query gen "CFObject=cfclient.Space"
//go:generate genny -in=../generics/query/generic-cf-service-base_test.go -out=gen-space-service-base_test.go -pkg query_test gen "CFObject=cfclient.Space"
...
//go:generate genny -in=../generics/query/generic-cf-service-base.go -out=gen-service-binding-service-base.go -pkg query gen "CFObject=cfclient.ServiceBinding"
//go:generate genny -in=../generics/query/generic-cf-service-base_test.go -out=gen-service-binding-service-base_test.go -pkg query_test gen "CFObject=cfclient.ServiceBinding"
...
//go:generate genny -in=../generics/query/generic-cf-service-base.go -out=gen-service-instance-service-base.go -pkg query gen "CFObject=cfclient.ServiceInstance"
//go:generate genny -in=../generics/query/generic-cf-service-base_test.go -out=gen-service-instance-service-base_test.go -pkg query_test gen "CFObject=cfclient.ServiceInstance"
